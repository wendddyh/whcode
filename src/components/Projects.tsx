...
const projects = [
  ...
  },
  {
    ...
    tools: ["Ruby on Rails", "Javascript", "Bootstrap"],
  ...
  },
  {
    ...
    description: "This is the simple first portfolio build with the most basic language.",
...
const Projects = () => {
  ...
  return (
    <Container sx={{ paddingTop: { xs: '6vh', md: '10vh', lg:'25vh'},
      ...
      <Typography sx={{fontFamily: `"DM Mono", monospace`, fontWeight:200, fontSize:'1.1em', color:'inherit'}}>
      ...
      <Grid2 container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} sx={{paddingTop:'5vh'}}>
        {projects.map((project, index) =>
          ...
          sx={{overflow:'hidden', border:'2px solid #18ffff', maxWidth:'500px', maxHeight:'350px',padding:"30px", background:'transparent', cursor: 'pointer', transform: 'translateY(0)',
            ...
            <Box  >
              ...
              <IconButton href={project.link} target="_blank" sx={{color: 'inherit'}}>
                <GitHubIcon sx={{fontSize:'1.2em',color: '#18ffff', '&:hover':{color: '#83B4B7'}}} />
              </IconButton>
            </Box>
            ...
            <Chip key={index} variant="outlined" sx={{color:'white',borderColor:'transparent',margin:'5px',spacing:'1vh', background:'#1C545F', fontFamily: `"Poppins", sans-serif`, transition:'background 1 ease', '&:hover':{borderColor: '#18ffff'}, fontWeight:500 }} label={tool}></Chip>)}
          </Paper>
        )}
      </Grid2>
    </Container>
