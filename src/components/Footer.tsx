...
const Footer = () => {
  return (
    <>
    <Container sx={{padding: '10vh', maxWidth: '1400px', margin:'auto'}}>
      <Box sx={{display:'flex', flexDirection:'column', justifyContent:'space-between',minHeight:'35vh',   }}>
        <Box>
          <Typography  sx={{fontFamily: `"Poppins", sans-serif`, fontWeight:600, fontSize:'2em'}}>
        ...
        <Box sx={{display:'flex', alignItems:'center', marginTop:'auto'}}>
          <Typography sx={{flexGrow: 1, fontSize:'1.2rem'}}>
            Made with <ConstructionIcon sx={{fontSize:'1.2rem', color:'pink', marginLeft:'3px', marginRight:'3px'}}/> and <FavoriteIcon sx={{fontSize:'1.2rem', color:'pink',  marginLeft:'3px', marginRight:'3px'}}/> by Wendy
          </Typography>
          <IconButton href="https://github.com/wendddyh">
          <Typography sx={{fontFamily: `"Poppins", sans-serif`, fontWeight:600, fontSize:'17px', '&:hover':{color: '#18ffff'}}}>GITHUB</Typography>
            {/* <GitHubIcon sx={{fontSize:'1.5rem', color:'pink',  '&:hover':{color: '#18ffff'}}}/> */}
          </IconButton>
          <IconButton href="https://www.linkedin.com/in/wenddyhenry/">
            <Typography sx={{fontFamily: `"Poppins", sans-serif`, fontWeight:600, fontSize:'17px', '&:hover':{color: '#18ffff'}}}>LINKEDIN</Typography>
            {/* <LinkedInIcon sx={{fontSize:'1.5rem', color:'pink',  '&:hover':{color: '#18ffff'}}}/> */}
          </IconButton>
          <IconButton href="mailto:wenddyhenry@gmail.com">
            <Typography sx={{fontFamily: `"Poppins", sans-serif`, fontWeight:600, fontSize:'17px', '&:hover':{color: '#18ffff'}}}>EMAIL</Typography>
